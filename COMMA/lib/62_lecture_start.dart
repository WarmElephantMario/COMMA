...
class LectureStartPage2 extends StatefulWidget {
  final String fileName;
  final String fileURL;
  final String response;

  const LectureStartPage2({
    Key? key,
  ...
  @override
  _LectureStartPage2State createState() => _LectureStartPage2State();
}

class _LectureStartPage2State extends State<LectureStartPage2> {
